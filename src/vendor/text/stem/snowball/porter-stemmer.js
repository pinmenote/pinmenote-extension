...
/**@constructor*/
export const PorterStemmer = function() {
    ...
    /** @const */ const /** Array<int> */ g_v = [17, 65, 16, 1];

    /** @const */ const /** Array<int> */ g_v_WXY = [1, 17, 65, 208, 1];
    ...
    this.stem = /** @return {boolean} */ function() {
        ...
        lab14: {
            ...
            while(true)
            {
                let /** number */ v_19 = base.cursor;
                lab15: {
                    golab16: while(true)
                    {
                        let /** number */ v_20 = base.cursor;
                        lab17: {
                            base.bra = base.cursor;
                            if (!(base.eq_s("Y")))
                            {
